...
EPOCHS = 200
net = ANN([32, 10, 10, 1], [ReLU(), ReLU(), Sigmoid()], MSE_LOSS(), CONSTANT_LEARNING_RATE(0.01), name="2l_ReLU")
...
# plt.show()
# weights = [np.load("./previously_trained/weights_100000_0.npy"), np.load("./previously_trained/weights_100000_1.npy")]
# biases = [np.load("./previously_trained/biases_100000_0.npy"), np.load("./previously_trained/biases_100000_1.npy")]

# net = ANN([32, 10, 1], [Sigmoid(), Sigmoid()], MSE_LOSS(), CONSTANT_LEARNING_RATE(0.01), weights=weights, biases=biases)
